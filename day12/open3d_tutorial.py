...
def download_fountain_dataset():
    fountain_path = _relative_path("../data/pointcloud/fountain_small")
    fountain_zip_path = _relative_path("../data/pointcloud/fountain.zip")
...
def get_armadillo_mesh():
    armadillo_path = _relative_path("../data/pointcloud/Armadillo.ply")
...
def get_bunny_mesh():
    bunny_path = _relative_path("../data/pointcloud/Bunny.ply")
...
def get_knot_mesh():
    mesh = o3d.io.read_triangle_mesh(_relative_path("../data/pointcloud/knot.ply"))
    mesh.compute_vertex_normals()
    return mesh


def get_eagle_pcd():
    path = _relative_path("../data/pointcloud/eagle.ply")
