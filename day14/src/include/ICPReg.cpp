...
//----- octree_division -----//
void ICPReg::octree_division(){

    if(!pcd->IsEmpty()){
        octree->ConvertFromPointCloud(*pcd,  0.01);
        open3d::visualization::DrawGeometries({octree}, "ICPReg");
    }       
    else{
...
void ICPReg::PrintVoxelGridInformation(const open3d::geometry::VoxelGrid& voxel_grid) {
